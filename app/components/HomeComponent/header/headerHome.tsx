        ...
        <YStack>
            <XStack style={styles.container}>
                ...
                <XStack style={styles.icons}>
                  ...
                  <Button style={styles.button} onPress={() => router.push('../NotificationComponent/notificationScreen')}>
                    <Icons.Bell size="$1.5" color={'#D88632'}/>
                  </Button>
                  <Button style={styles.button}>
                    <Icons.MessageSquareText size="$1.5" color={'#D88632'} onPress={() => router.push('../ChatComponent/screen')}/>
                  </Button>
                </XStack>
            </XStack>
            <Separator />
