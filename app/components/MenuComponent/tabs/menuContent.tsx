...
import { users, User } from '../../ProfileScreen/data/users'
        ...
        <YStack style={styles.dropdown}>
            ...
            <AnimatePresence>
                    {open && (
                      ...
                      >
                        <XStack>
                            <Button onPress={() => router.push('../ProfileScreen/profileScreen')} style={styles.contentButton}>
        ...
        <TamaguiProvider config={config}>
            <YStack>
                <View flexDirection="row" flexWrap="wrap" justify="space-between" px="$4" verticalAlign='center'>
                    <Button style={pageStyles.button} onPress={() => router.push('../GroupsComponent/groupsScreen')}>
                        <Icons.Users/>
                        <Text>Groups</Text>
                    </Button>
                    <Button style={pageStyles.button} onPress={() => router.push('../EventsComponent/eventsScreen')}>
                        <Icons.Calendar/>
                        <Text>Events</Text>
                    </Button>
                    <Button style={pageStyles.button} onPress={() => router.push('../SavedComponent/savedScreen')}>
                        <Icons.Bookmark/>
                        <Text>Saved</Text>
                    </Button>
                    <Button style={pageStyles.button} onPress={() => router.push('../FriendsComponent/tabs/friends')}>
                        <Icons.UserCheck/>
                        <Text>Friends</Text>
                    </Button>
                    <Button style={pageStyles.button} onPress={() => router.push('../AudiobookComponent/audiobookScreen')}>
                        <Icons.BookAudio/>
                        <Text>Audiobooks</Text>
                    </Button>
                    <Button style={pageStyles.button} onPress={() => router.push('../BooksComponent/booksScreen')}>
                        <Icons.LibraryBig/>
                        <Text>Books</Text>
                    </Button>
                    ...
                    <AnimatePresence >
                        ...
                        >
                            <Button style={pageStyles.button} onPress={() => router.push('../BadgesComponent/badgesScreen')}>
                                <Icons.Badge/>
                                <Text>Badges</Text>
                            </Button>
                            <Button style={pageStyles.button} onPress={() => router.push('../ForumsComponent/forumsScreen')}>
                                <Icons.MessagesSquare/>
                                <Text>Forums</Text>
                            </Button>
                            <Button style={pageStyles.button} onPress={() => router.push('../PollsComponent/pollsScreen')}>
                                <Icons.ChartNoAxesColumn/>
                                <Text>Polls</Text>
                            </Button>
                            <Button style={pageStyles.button} onPress={() => router.push('../SurveyComponent/surveysScreen')}>
                                <Icons.ClipboardPen/>
                                <Text>Surveys</Text>
                            </Button>
                            <Button style={pageStyles.button} onPress={() => router.push('../PetitionComponent/petitionsScreen')}>
