    ...
    <TamaguiProvider config={config}>
        <YStack style={styles.container}>
            ...
            <XStack style={styles.rememberContainer}>
                ...
                <Anchor href='/ForgotPassword/forgotPassword' >
            ...
            <Button style={styles.loginButton} onPress={() => router.push('../HomeComponent/homeScreen')}>
            ...
            <XStack style={styles.signupContainer}>
                ...
                New to Exodus?
                <Anchor href='./SignUp/signUp' style={styles.signupLink}>Sign Up</Anchor>
            </Text>
            </XStack>
        </YStack>
    </TamaguiProvider>
